...
<script>
    ...
    var fc_pn_negociator_options = '{if $froggypricenegociator.ps_version eq '1.4'}<tr><td colspan="2"><hr style="width:100%;" id="froggypricenegociator-separator">{else}<div class="separation" id="froggypricenegociator-separator"></div>{/if}<table> \
        <tr><td colspan="2"><h4 id="froggypricenegociator-title">{l s='Froggy Price Negotiator' mod='froggypricenegociator' js=1}</h4></td></tr> \
        ...
        <tr id="froggypricenegociator-checkbox-details"> \
            ...
            <td><input type="checkbox" value="1" style="padding-top: 5px;" id="froggypricenegociator-option" name="froggypricenegociator_option" {if $froggypricenegociator.fpn_product->active}checked="checked"{/if}>&nbsp; \
                <label id="froggypricenegociator-option-label" class="t froggypricenegociator-label" for="froggypricenegociator-option">{l s='Enable price negotiation button for this product' mod='froggypricenegociator' js=1}</label></td> \
            </tr> \
        {if $froggypricenegociator.FC_PN_TYPE eq 'PRICE_MINI'}
        <tr id="froggypricenegociator-details"> \
            <td class="col-left"><label class="froggypricenegociator-label" id="froggypricenegociator-label-field-2">{l s='Minimum price sell:' mod='froggypricenegociator' js=1}</label></td> \
            <td> \
            ...
            {else}
        <tr id="froggypricenegociator-details"> \
            <td class="col-left"><label class="froggypricenegociator-label" id="froggypricenegociator-label-field-2">{l s='Percent:' mod='froggypricenegociator' js=1}</label></td> \
            <td> \
                - <input type="text" value="{$froggypricenegociator.fpn_product->reduction_percent_max}" style="padding-top: 5px;" id="froggypricenegociator-reduction-percent-max" name="froggypricenegociator_reduction_percent_max"><span id="froggypricenegociator-reduction-percent-max-label">%, {l s='In that case, the minimum sell price will be' mod='froggypricenegociator' js=1}</span>  \
